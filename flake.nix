{
  description = "Rotorflight Releases Proxy";
      ...
      let
        nixpatchbins = pkgs.writers.writeBashBin "nixpatchbins" ''
          ...
          BIN_EXECUTABLES_TO_PATCH=(
            $(cd node_modules/@cloudflare/vitest-pool-workers && node -e 'console.log(require.resolve("@cloudflare/workerd-linux-64/bin/workerd"))')
          )
